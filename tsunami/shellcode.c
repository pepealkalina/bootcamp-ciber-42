...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/12 13:22:27 by preina-g          #+#    #+#             */
...
int main () {
    __asm{
        ...
        push eax
        mov ebx,\x7c801d7b              ; Direccion de memoria de la libreria 'LoadLibrary'
        ...
        push eax
        mov  ebx\x77c293c7            ; Direccion de memoria de la libreria 'system'
        call ebx                        ; Sacada con offset.c
    }
}